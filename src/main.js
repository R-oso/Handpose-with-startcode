...
const btnTrainKick = document.getElementById("btnTrainKick");
const btnTrainSnare = document.getElementById("btnTrainSnare");
const btnTrainHat = document.getElementById("btnTrainHat");
const btnClassify = document.getElementById("btnClassify");

// posities van vingers
...
// Teken een rectangle
async function drawRect(ctx, x, y, w, h) {
  ctx.beginPath();
  ctx.fillStyle = "blue";
